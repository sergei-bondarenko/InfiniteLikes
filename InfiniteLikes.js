...
$(document).ready(function() {
  ...
  setTimeout(function(){ main("sub", 300); }, 5000);     // через 5 с запускаем подписку странички с интервалом в 300 с
  setTimeout(function(){ main("group", 300); }, 10000);  // ещё через 5 с запускаем подписку на группы с интервалом в 300 с
